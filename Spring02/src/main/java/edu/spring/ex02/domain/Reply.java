...
public class Reply {
	...
	public String toString() {
		return String.format("Reply{rno: %d, rtext: %s, userid : %s,regdate:%s bno : %d}", this.rno,this.rtext,this.userid,this.regdate,this.bno);
	}
