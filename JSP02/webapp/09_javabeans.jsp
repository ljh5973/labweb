...
<html>
	 ...
	 * public으로 선언된 getter/setter 메서드들이 있어야 함. (메서드 이름은 Java 코딩 관습에 따라야 함.)
	 --%>
	 
	 <h2>scriptlet, expression을 이용한 자바 객체 이용</h2>
	 <% // scriptlet
	 ...
	 <jsp:setProperty property="memberPassword" name="m2" value="abcd"/>
	 <jsp:setProperty property="memberEmail" name="m2" value="admin@test.com"/>
